...
-- AXOLOT GAMES I FUCKING HATE YOU

dofile("$CONTENT_632be32f-6ebd-414e-a061-d45906ae4dc6/Scripts/Config.lua")

sm.scrapcomputers.backend.gameHook = {}
sm.scrapcomputers.backend.gameHook.customGameLocalId = "DATA"
sm.scrapcomputers.backend.gameHook.gamemodeType = "Vanilla"
sm.scrapcomputers.backend.gameHook.isGamemodeSurvival = false

GameHookClass = class()

function GameHookClass:server_onCreate()
    sm.gui.chatMessage("#00c0e0NOTICE:#eeeeee Certain features with ScrapComputers have either been degraded or removed thanks to Chapter 2. More information provided in the Discord Server.")
end